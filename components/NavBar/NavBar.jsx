...
const NavBar = () => {
  ...
  // smart contract data
  const { currentAccount, userData, connectWallet } =
    ...
    <div className={Style.navbar}>
      <div className={Style.navbar_container}>
        <div className={Style.navbar_container_left}>
          ...
          >
            <div className={Style.logo}>
              <Image src={images.logo} alt="Askify" width={100} height={100} />
            </div>
        ...
        <div className={Style.navbar_container_right}>
          ...
          <div className={Style.navbar_container_right_profile_theme}>
            <ThemeSwitch />
          </div>
